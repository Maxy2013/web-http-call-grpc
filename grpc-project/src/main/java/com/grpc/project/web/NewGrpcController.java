package com.grpc.project.web;

import com.grpc.project.model.request.GrpcRequest;
import com.grpc.project.model.request.PaymentRequest;
import com.grpc.project.model.response.CardInfo;
import com.grpc.project.model.response.OrderInfo;
...
//        System.out.println("groupAccumulatorReply --->" + groupAccumulatorReply);
    ...
    public void queryGroupInfo(GrpcRequest grpcRequest){
        ...
        params.setBeId("100");
        params.setCustId("1711000000315007");
        params.setEntityType("G");
        params.setEntityId("1711000000310201");
    ...
    public void paycheck(){
        ...
        params.setBeId("100");
        params.setCustId("5111000004004068");
        params.setEntityId("17296402440");
        params.setEntityType("M");
    ...
    public String billPayment(){
        ...
        paymentParams.setCustId("5111000004004068");
        Page.Builder page = Page.newBuilder();
        page.setIndex(1);
        page.setSize(10);
        page.setChannel("API");
        paymentParams.setEntityId("5111000002996026");//---A
        paymentParams.setEntityId("17296402440");//---M
